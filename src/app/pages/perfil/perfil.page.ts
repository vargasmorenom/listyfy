...
import { IonContent, IonIcon, IonItem, IonButton,IonSegment, 
...
@Component({
  ...
  standalone: true,
  imports: [IonInfiniteScrollContent, IonInfiniteScroll, IonButton,IonContent, CommonModule, 
            FormsModule,SessionComponent, ContentListComponent,InfoPerfilComponent,
            IonLabel, ReactiveFormsModule,ProfileComponent,MenubajoComponent,IonSegment, 
            IonSegmentButton]
})
