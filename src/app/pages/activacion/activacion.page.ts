...
@Component({
  ...
  standalone: true,
  imports: [IonCard, IonCardHeader, IonCardSubtitle, IonCardTitle,IonContent,SessionComponent, CommonModule, FormsModule]
})
...
constructor(private param: ActivatedRoute,private navegar:Router, private activacion: ActivacionService) {
