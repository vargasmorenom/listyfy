...
import { IonHeader,IonIcon, IonToolbar,IonTitle,IonButtons,IonButton,IonContent,IonInput,IonSelectOption,
         IonTextarea,IonItem,IonLabel,IonSelect,IonList,IonRadioGroup,IonRadio} from '@ionic/angular/standalone';

@Component({
  selector: 'app-editcontentlist',
  templateUrl: './editcontentlist.component.html',
  styleUrls: ['./editcontentlist.component.scss'],
  imports: [IonHeader,IonIcon,IonSelect, IonToolbar, IonSelectOption,IonList,IonRadioGroup,IonRadio, IonTitle,IonLabel, IonButtons, IonButton, IonInput, IonItem,IonTextarea,IonContent, FormsModule, ReactiveFormsModule],
  standalone: true,
})
...
@Input() onComplete!: (postId: string) => void;
 ...
 constructor(public formUl: DynamicFormService,
  ...
  ngOnInit() {console.log('🧪 onComplete recibido en hijo:', this.onComplete);}
